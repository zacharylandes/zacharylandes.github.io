...
var colors1 = [ getRandomColor(), getRandomColor(), getRandomColor()]
var colorCount= 0;
var lineLength = 10;
var angle = 0;
var canvasx = Math.floor((Math.random() * screenWidth *.5) + 1);
var canvasy = Math.floor((Math.random() * screenHeight *.5) + 1);
var fractalCount = 0;
