...
var colors1 = [[200,20,200]]
var colors = [ '#585555']
var colorCount= 0;
var lineLength = 10;
var angle = 0;
var canvasx = Math.floor((Math.random() * screenWidth) + 1);
var canvasy = Math.floor((Math.random() * screenHeight) + 1);
var fractalCount = 0;
var fractalInterval = setInterval(function(){changeTree(100,4,.2,500)}, 10)

function changeTree(anglechange,depth, lineLengthChange,fractalTotal){
    context.beginPath();
...
function drawTree(x1, y1, angle, depth){
 ...
 if (colorCount=== 5){colorCount=0};
  if (canvasx === 200){canvasx=500};
  if (canvasy === 200){canvasy=500};
  if (angle=== 360){angle=0};
  if (lineLength === 200){lineLength=0};
}}
...
},{"pleasejs":2}],2:[function(require,module,exports){
